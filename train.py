...
class Train:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"D:\Project\Attendence face recognition\Images_GUI\t_bg1.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"D:\Project\Attendence face recognition\Images_GUI\t_btn1.png")
